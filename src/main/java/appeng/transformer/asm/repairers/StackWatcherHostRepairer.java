...
public class StackWatcherHostRepairer extends InterfaceMethodRepairer {
    ...
    static final String descOSCNew = "(Lappeng/api/storage/data/IItemList;Lappeng/api/storage/data/IAEStack;Lappeng/api/storage/data/IAEStack;Lappeng/api/networking/security/BaseActionSource;Lappeng/api/storage/IStorageChannel;)V";
